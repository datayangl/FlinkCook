...
import static com.code.ly.sql.formats.csv2.CsvUdfOptions.*;
import static org.apache.flink.formats.csv.CsvOptions.*;
 ...
 */
public final class CsvFormatFactory2
        implements DeserializationFormatFactory, SerializationFormatFactory {

    public static final String IDENTIFIER = "csv2";
    ...
    public DecodingFormat<DeserializationSchema<RowData>> createDecodingFormat(
        ...
        return new DecodingFormat<DeserializationSchema<RowData>>() {
            ...
            public DeserializationSchema<RowData> createRuntimeDecoder(
                ...
                final CsvRowDataDeserializationSchema2.Builder schemaBuilder =
                        new CsvRowDataDeserializationSchema2.Builder(rowType, rowDataTypeInfo);
    ...
    public Set<ConfigOption<?>> optionalOptions() {
        ...
        options.add(SECOND_FIELD_DELIMITER);
        options.add(DISCARD_PREFIX_FIELD_DELIMITER);
    ...
    private static void configureDeserializationSchema(
            ReadableConfig formatOptions, CsvRowDataDeserializationSchema2.Builder schemaBuilder) {
        formatOptions
        ...
        formatOptions.getOptional(SECOND_FIELD_DELIMITER)
                .ifPresent(schemaBuilder::setSecondFieldDelimiter);

        formatOptions.getOptional(DISCARD_PREFIX_FIELD_DELIMITER)
                .ifPresent(schemaBuilder::setDiscardPrefixField);

        formatOptions.getOptional(IGNORE_TRAILING_UNMAPPABLE)
